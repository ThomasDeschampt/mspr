...
const { afficherPlante, afficherPlanteFaitesGardees, afficherPlanteGardees, recupererlocalisation, ajouterPlante, ajouterGardienPlante} = require("../api/Plante");
...
router.get("/recupererlocalisation", async (req,res) => {
    try {
        ...
        res.status(500).json({
          message: "Erreur lors de la récupération de la localisation de la plante:",
          erreur: erreur.message,
        });
    }   
})
