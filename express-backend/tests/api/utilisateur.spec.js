const { ajouterUtilisateur, verifierUtilisateur, supprimerUtilisateur } = require('../../api/Utilisateur');
...
describe('Test des fonctions utilisateur', () => {
  ...
  it('Devrait ajouter un nouvel utilisateur', async () => {
    ...
    expect(console.log).toHaveBeenCalledWith('Nouvel utilisateur ajouté:', nouvelUtilisateurMock);
  });
  ...
  it('Devrait vérifier l\'utilisateur existant', async () => {
    ...
    const resultat = await verifierUtilisateur('psd_utl_existant', 'mdp_utl_existant');
  ...
  it('Devrait vérifier l\'utilisateur non existant', async () => {
    ...
    const resultat = await verifierUtilisateur('psd_utl_non_existant', 'mdp_utl_non_existant');
