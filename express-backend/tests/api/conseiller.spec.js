...
describe('Test des fonctions de conseillage', () => {
  ...
  describe('Test de afficherConseillage', () => {
    ...
    it('Devrait afficher une erreur en cas de problème', async () => {
      ...
      await expect(afficherConseillage(1)).rejects.toThrow('Erreur de recherche');
    });
  });
  ...
  describe('Test de ajouterConseillage', () => {
    ...
    it('Devrait ajouter un nouveau conseillage', async () => {
      ...
      expect(Conseiller.create).toHaveBeenCalledWith({ id_cns: id_cns, id_utl: id_utl });
    });
    ...
    it('Devrait afficher une erreur en cas de problème', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Erreur lors de l\'ajout du conseillage');
    });
  });
});
